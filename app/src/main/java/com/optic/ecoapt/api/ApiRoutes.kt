...
class ApiRoutes {
    ...
    val API_URL = "https://laboratorioreciclajea-default-rtdb.firebaseio.com"
    val API_LOCAL = "http://192.168.56.1:3000/api/"
    val retrofit = RetrofitClient()

    fun getUsersRoutes():UsersRoutes {
        return retrofit.getClient(API_LOCAL).create(UsersRoutes::class.java)
    }
